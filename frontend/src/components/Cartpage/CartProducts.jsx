...
function CartProducts({ item }) {
  ...
  return (
    <div
      key={item._id}
      className="grid grid-cols-4 md:grid-cols-6 gap-4 items-center border-b py-8"
    >
      <img src={item.productImg} alt="" className="w-30" />
      <div className="col-span-1 w-auto hidden md:flex">
